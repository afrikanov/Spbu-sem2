...
public final class FirstPartTasks {
    ...
    public static long countAlbumDuplicates(Stream<Album> albums) {
        return albums
                .collect(Collectors.groupingBy(album -> album.getName(), Collectors.counting()))
                .values()
                .stream()
                .filter(albumsAmount -> albumsAmount >= 2)
                .count();
    }
    ...
    public static List<Album> sortByAverageRating(Stream<Album> albums) {
        return albums.sorted(Comparator.comparingDouble(album -> -album.getTracks()
                        .stream()
    ...
    public static int moduloProduction(IntStream stream, int modulo) {
        return stream.reduce(1, (firstNumber, secondNumber) -> (firstNumber * secondNumber) % modulo);
    }
